...
const Page = () => {
  ...
  const { load, commit } = Util.useChangeLogRepository(keyOfNewItem as Util.ItemKey | undefined)
    ...
    <>
      <VForm.Container leftColumnMinWidth="17.6rem">
        ...
        <VForm.Item label="LogTime">
          <Input.Date {...registerEx(`own_members.LogTime`)} />
        </VForm.Item>
        <VForm.Item label="UpdatedObject">
          <Input.Word {...registerEx(`own_members.UpdatedObject`)} />
        </VForm.Item>
        <VForm.Item label="UpdateType">
          <Input.Word {...registerEx(`own_members.UpdateType`)} />
        </VForm.Item>
        <VForm.Item label="RowIdOrRowTypeId">
          <Input.Word {...registerEx(`own_members.RowIdOrRowTypeId`)} />
        </VForm.Item>
        <VForm.Item label="Content">
          <Input.Description {...registerEx(`own_members.Content`)} />
        </VForm.Item>
      </VForm.Container>
    </>
  )
