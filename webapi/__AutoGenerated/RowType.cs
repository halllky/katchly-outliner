...
=======
    ...
    partial class AutoGeneratedApplicationService {
        ...
        /// <summary>
        /// RowTypeの新規登録SQL発行後、コミット前に実行されます。
        /// </summary>
...
#region データ構造クラス
    ...
    /// <summary>
    /// ほかの集約がColumnsを参照するときに必要になる、どのColumnsを指し示すかのキー情報。
    /// </summary>
    ...
    /// <summary>
    /// Entity Framework Core のルールに則ったRowTypeのデータ型
    /// </summary>
    ...
    /// <summary>
    /// Entity Framework Core のルールに則ったColumnsのデータ型
    /// </summary>
    ...
    /// <summary>
    /// RowTypeの画面表示用データのうちRowType自身の属性
    /// </summary>
    ...
    /// <summary>
    /// Columnsの画面表示用データのうちColumns自身の属性
    /// </summary>
    ...
    // ----------------------- RowTypeRefInfo -----------------------
    /// <summary>
    /// 他のデータがRowTypeを参照している場合に、その参照元のデータの画面上に表示されるRowTypeのデータ型。
    /// </summary>
    ...
    // ----------------------- ColumnsRefInfo -----------------------
    /// <summary>
    /// 他のデータがColumnsを参照している場合に、その参照元のデータの画面上に表示されるColumnsのデータ型。
    /// </summary>
...
>>>>>>> d52136f (wip 列の型に文字列以外にほかの行への参照をとれるようにする)
}
