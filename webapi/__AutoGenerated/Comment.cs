...
=======
    ...
    partial class AutoGeneratedApplicationService {
        ...
        /// <summary>
        /// Commentの新規登録SQL発行後、コミット前に実行されます。
        /// </summary>
...
#region データ構造クラス
    ...
    /// <summary>
    /// ほかの集約がCommentを参照するときに必要になる、どのCommentを指し示すかのキー情報。
    /// </summary>
    ...
    /// <summary>
    /// Entity Framework Core のルールに則ったCommentのデータ型
    /// </summary>
    ...
    /// <summary>
    /// Commentの画面表示用データのうちComment自身の属性
    /// </summary>
    ...
    // ----------------------- CommentRefInfo -----------------------
    /// <summary>
    /// 他のデータがCommentを参照している場合に、その参照元のデータの画面上に表示されるCommentのデータ型。
    /// </summary>
